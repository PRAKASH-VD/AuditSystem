        ...
        <div className="relative mx-auto max-w-6xl">
          <nav className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-3">
              ...
              <NavLink to="/app" className="rounded-full bg-(--accent) px-4 py-2 text-xs font-semibold text-white">
                Go to App
              </NavLink>
            </div>
          </nav>
          ...
          <div className="mt-16 grid gap-10 lg:grid-cols-[1.1fr_0.9fr]">
            <div>
              <p className="text-xs uppercase tracking-[0.4em] text-(--muted)">Smart Reconciliation</p>
              ...
              <div className="mt-8 flex flex-wrap gap-3">
                <NavLink to={primaryLink} className="rounded-full bg-(--ink) px-6 py-3 text-sm font-semibold text-white">
                  {primaryLabel}
                </NavLink>
            ...
            <div className="rounded-3xl border border-black/10 bg-white/80 p-6 shadow-xl">
              <p className="text-xs uppercase tracking-widest text-(--muted)">Live Snapshot</p>
              ...
              <div className="mt-6 rounded-2xl border border-black/10 bg-white px-4 py-3">
                <p className="text-xs text-(--muted)">Next scheduled audit</p>
